    ...
    module Support
      module Backends
        ...
        module ClassMethods
          ...
          def enqueue_for_backend(worker, class_name, subject_id, mounted_as, filename, file_as_base64, content_type)
            self.send :"enqueue_#{backend}", worker, class_name, subject_id, mounted_as, filename, file_as_base64, content_type
          end
